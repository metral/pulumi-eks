...
export interface CoreData {
    ...
    encryptionConfig?: pulumi.Output<aws.types.input.eks.ClusterEncryptionConfig>;
}
...
export function createCore(name: string, args: ClusterOptions, parent: pulumi.ComponentResource, provider?: pulumi.ProviderResource): CoreData {
    ...
    // Kubernetes secrets.
    let encryptionProvider: pulumi.Output<aws.types.input.eks.ClusterEncryptionConfigProvider> | undefined;
    let encryptionConfig: pulumi.Output<aws.types.input.eks.ClusterEncryptionConfig> | undefined;
    if (args.encryptionConfigKeyArn) {
        encryptionProvider = pulumi.output(args.encryptionConfigKeyArn).apply(
            keyArn => <aws.types.input.eks.ClusterEncryptionConfigProvider>({keyArn}),
        );
        encryptionConfig = encryptionProvider.apply(encryptProvider => (<aws.types.input.eks.ClusterEncryptionConfig>{
